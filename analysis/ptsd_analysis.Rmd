...
ggplot(ldf, 
  ...
  # #scale_y_log10() +
  ylim(0, 1.6) +
  ylab(expression(paste("Odds of Retrieving Memory ", italic(m))))+
  scale_color_viridis(option="plasma", discrete=T, end = .8) +
  theme_pander()
```
...
ggplot(IC_a, 
  ...
  labs(col="PTE Intensity", fill="PTE Intensity", facet="Z") +
